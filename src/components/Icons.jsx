export const SubmitIcon = (props) => (
  <div viewBox="0 0 24 24">
    <svg width="18" height="17" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M8.07492 14.563C11.7568 14.563 14.7416 11.5783 14.7416 7.89633C14.7416 4.2144 11.7568 1.22961 8.07492 1.22961C4.39299 1.22961 1.4082 4.2144 1.4082 7.89633C1.4082 11.5783 4.39299 14.563 8.07492 14.563Z" stroke="#29243E" stroke-width="1.50001" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M16.4082 16.2296L12.7832 12.6046" stroke="#29243E" stroke-width="1.50001" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
...
export const CloseIcon = (props) => (
  <div onClick={props.onClick} viewBox="0 0 24 24">
    <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M21 7L7 21" stroke="#29243E" stroke-width="2.2" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M7 7L21 21" stroke="#29243E" stroke-width="2.2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  </div>
);
...
export const EmailIcon = () => (
  <div viewBox="0 0 18 18">
    <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M3 2.99976H15C15.825 2.99976 16.5 3.67476 16.5 4.49976V13.4998C16.5 14.3248 15.825 14.9998 15 14.9998H3C2.175 14.9998 1.5 14.3248 1.5 13.4998V4.49976C1.5 3.67476 2.175 2.99976 3 2.99976Z" stroke="#5A52B9" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
      <path d="M16.5 4.5L9 9.75L1.5 4.5" stroke="#5A52B9" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
    </svg>
...
export const WebIcon = () => (
  <div viewBox="0 0 19 19">
    <svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M9.5 18C14.1944 18 18 14.1944 18 9.5C18 4.80558 14.1944 1 9.5 1C4.80558 1 1 4.80558 1 9.5C1 14.1944 4.80558 18 9.5 18Z" stroke="#5A52B9" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
      <path d="M1 9.5H18" stroke="#5A52B9" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
      <path d="M9.49979 1C11.6259 3.3276 12.8341 6.34823 12.8998 9.5C12.8341 12.6518 11.6259 15.6724 9.49979 18C7.3737 15.6724 6.16545 12.6518 6.09979 9.5C6.16545 6.34823 7.3737 3.3276 9.49979 1Z" stroke="#5A52B9" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
    </svg>
...
export const LocationPinIcon = () => (
  <div viewBox="0 0 21 20">
    <svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M18 8.33337C18 14.1667 10.5 19.1667 10.5 19.1667C10.5 19.1667 3 14.1667 3 8.33337C3 6.34425 3.79018 4.4366 5.1967 3.03007C6.60322 1.62355 8.51088 0.833374 10.5 0.833374C12.4891 0.833374 14.3968 1.62355 15.8033 3.03007C17.2098 4.4366 18 6.34425 18 8.33337Z" stroke="#5A52B9" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
      <path d="M10.5 10.8334C11.8807 10.8334 13 9.71409 13 8.33337C13 6.95266 11.8807 5.83337 10.5 5.83337C9.11929 5.83337 8 6.95266 8 8.33337C8 9.71409 9.11929 10.8334 10.5 10.8334Z" stroke="#5A52B9" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
    </svg>
