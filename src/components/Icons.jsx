...
export const CloseIcon = (props) => (
  <div onClick={props.onClick} viewBox="0 0 24 24">
    <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path className="closeIcon" d="M21 7L7 21" stroke="#29243E" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" />
      <path className="closeIcon" d="M7 7L21 21" stroke="#29243E" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  </div>
);
